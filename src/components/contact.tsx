...
export default function Contact() {
	return (
		<div
			id="contact"
			className="flex flex-col md:flex-row contact-card rounded-[1.5vw] p-4 m-4"
		>
			{/* (SM)Top (LG)Left */}
			<div className="flex flex-col justify-center p-4 md:min-w-[50%]">
				...
				<p className="font-medium md:text-[24px]">
					Are you ready to bring your vision to life? Fill out the
					form to get in touch with me, and let&apos;s discuss how we
					can work together.
				</p>
			</div>
			...
			<div className="flex flex-col justify-center p-4 md:min-w-[50%] border-white">
				<form
					className="md:p-4"
					action="https://send.pageclip.co/ZHvMZSYcBnzvTOkNnWViIJjQRMKksyTc"
					method="post"
				>
					...
					<input
						...
						className="w-full p-1.5 mb-1 rounded-md bg-transparent border-[1px]"
						autoComplete="on"
						required
					/>
					...
					<p className="text-white font-medium pt-2.5 pb-1">
						Message
					</p>
					<textarea
						name="message"
						aria-label="Message Field"
						className="w-full min-h-20 p-1.5 rounded-md bg-transparent border-[1px]"
						required
					/>
